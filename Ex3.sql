...
insert into customers values(21,'KAUSHIK','RAM');
...
(select cid from Receipts group by Receipts.cid, Receipts.rdate having count(*) > 2);
...
select count(count(*)) from item_list where item in 
